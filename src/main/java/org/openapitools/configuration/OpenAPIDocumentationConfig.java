...
public class OpenAPIDocumentationConfig {
    ...
    ApiInfo apiInfo() {
        return new ApiInfoBuilder()
            ...
            .termsOfServiceUrl("")
            .version("1.0.0")
            .contact(new Contact("","", "team-m@fh-burgenland.at"))
            .build();
    }

    @Bean
    public Docket customImplementation(ServletContext servletContext, @Value("${openapi.fsuWeatherRest.base-path:/api/v1}") String basePath) {
